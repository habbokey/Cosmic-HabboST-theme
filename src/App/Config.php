...
{    
   /**
    ...
    const client = [
      ...
      "nitro_path"                  => "http://localhost/nitro-react-flashUI/build"
    ];
    ...
    const site = [
      ...
      "cpath"       => "http://localhost/ms-swf",
      "fpath"       => "https://hazbo.me/",
      "shortname"   => "Cosmic",
      "sitename"    => "Cosmic",
	  "discord_widgetid"    => "966138336236417094", /** Discord Widget ID */
      "discord_link"=> "https://discord.gg/Nq4VV5dC", /** Discord invite link */
	  "app_dwnl"    => "", /** App download link */
      "ltd_link"    => "https://cdn.habtium.com/habtium/furni/items/big/41.gif", /** Next LTD cooming soon, pick image from https://habtium.es */
    ];
